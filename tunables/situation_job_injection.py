...
from sims4.tuning.tunable import TunableList, TunableReference, TunableTuple, Tunable, OptionalTunable
...
class TunableSituationJobInjection(BaseTunableInjection):
    ...
    __slots__ = ('situation_jobs', 'spawn_action_override', 'alternative_spawn_behaviors',)
